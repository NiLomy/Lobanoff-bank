...
import ru.kpfu.itis.lobanov.commissionservice.aspects.LoggerAspect;
...
public class LoggerConfig {
    ...
    @Around(value = "ru.kpfu.itis.lobanov.commissionservice.aspects.LoggerAspect.serviceMethod()")
    ...
    @AfterThrowing(value = "ru.kpfu.itis.lobanov.commissionservice.aspects.LoggerAspect.serviceMethod()")
