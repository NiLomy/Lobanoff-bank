...
import ru.kpfu.itis.lobanov.aspects.LoggerAspect;
...
public class LoggerConfig {
    ...
    @Around(value = "ru.kpfu.itis.lobanov.aspects.LoggerAspect.serviceMethod()")
    ...
    @AfterThrowing(value = "ru.kpfu.itis.lobanov.aspects.LoggerAspect.serviceMethod()")
