...
import ru.kpfu.itis.lobanov.cashbackservice.aspects.LoggerAspect;
...
public class LoggerConfig {
    ...
    @Around(value = "ru.kpfu.itis.lobanov.cashbackservice.aspects.LoggerAspect.serviceMethod()")
    ...
    @AfterThrowing(value = "ru.kpfu.itis.lobanov.cashbackservice.aspects.LoggerAspect.serviceMethod()")
