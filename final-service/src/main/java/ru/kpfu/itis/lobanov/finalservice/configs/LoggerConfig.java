...
import ru.kpfu.itis.lobanov.finalservice.aspects.LoggerAspect;
...
public class LoggerConfig {
    ...
    @Around(value = "ru.kpfu.itis.lobanov.finalservice.aspects.LoggerAspect.serviceMethod()")
    ...
    @AfterThrowing(value = "ru.kpfu.itis.lobanov.finalservice.aspects.LoggerAspect.serviceMethod()")
