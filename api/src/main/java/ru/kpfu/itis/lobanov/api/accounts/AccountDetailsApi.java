...
public interface AccountDetailsApi {
    ...
    @GetMapping("/{id}")
    String showAccountDetailsPage(@Parameter(description = "Id of the current user's account.", example = "123") @PathVariable("id") String accountId, @Parameter(description = "Model of the page.") Model model);
